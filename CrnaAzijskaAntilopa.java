...
public class CrnaAzijskaAntilopa extends JDialog {
	...
	public static void main(String[] args) {
		try {
			CrnaAzijskaAntilopa dialog = new CrnaAzijskaAntilopa();
	...
	public static void CrnaAzijskaAntilopa() {
		try {
			CrnaAzijskaAntilopa dialog = new CrnaAzijskaAntilopa();
			dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
			dialog.setVisible(true);
	...
	public CrnaAzijskaAntilopa() {
		...
		contentPanel.setLayout(null);
		{
			...
			Image slike = new ImageIcon(this.getClass().getResource("/Antilopa.png")).getImage();
			label.setIcon(new ImageIcon(slike));
			label.setBounds(10, 11, 321, 319);
			contentPanel.add(label);
		}
		
		JLabel lblAntilopa = new JLabel("Crna azijska antilopa");
		lblAntilopa.setForeground(new Color(0, 0, 0));
		lblAntilopa.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblAntilopa.setBounds(361, 11, 189, 42);
		contentPanel.add(lblAntilopa);
		...
		txtpnKolikoPutaSte.setBounds(341, 49, 229, 276);
		...
		txtpnPasminakotskogGoveda.setBounds(10, 329, 560, 145);
